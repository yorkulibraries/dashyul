...
\label{sec:orgfe08403}

\begin{figure}[htbp]
\centering
\includegraphics[height=3in]{logic-flow.png}
\caption{\label{fig:org20e02cb}
Easy Weeder logic}
\end{figure}

To revisit the examples above, two are ignored because their busy factor is >= 1.  For the remaining four we can calculate the recommended number of copies we should keep.  Figure \ref{fig:org20e02cb} shows the decisions made.
