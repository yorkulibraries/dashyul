...
\label{sec:org4b0f174}

\begin{figure}[htbp]
\centering
\includegraphics[height=3in]{logic-flow.png}
\caption{\label{fig:orga3643d6}
Easy Weeder logic}
\end{figure}

To revisit the examples above, two are ignored because their busy factor is >= 1.  For the remaining four we can calculate the recommended number of copies we should keep.  Figure \ref{fig:orga3643d6} shows the decisions made.
