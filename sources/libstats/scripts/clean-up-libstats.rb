...
# Method to use if the CSV is invalid, and we need
# to read it in line by line and parse each as CSV,
# in order to rescue errors.

# File.open(all_libraries_csv).each_line do |input_row|
#   begin
