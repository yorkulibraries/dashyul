## We want checkouts of everything that isn't an accessory, laptop,
## headphone, etc.

## These item types should be normalised---looks like
## people sometimes make up new ones.

current_checkouts <- all_transaction_details %>%
